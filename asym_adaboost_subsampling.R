...
for (s in seq(0.21,0.29,0.01)){
  # create the results directory
  dir.create(file.path(paste("/zheliu/DevGSEA/result2019/imbalanced_50_", s, sep="")), showWarnings = FALSE)
  res.dir<- paste("/zheliu/DevGSEA/result2019/imbalanced_50_", s, sep="")
...
save.image("/zheliu/DevGSEA/result2019/imbalanced 50/combined weighted voting.Rdata")
# load("/zheliu/DevGSEA/result2019/combined weighted voting.Rdata")
