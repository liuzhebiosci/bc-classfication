...
sub.ratio<- 0.3
  ...
  # round(min(table(as.factor(exprs.class)))/sum(table(as.factor(exprs.class))),3)

# create the results directory
dir.create(file.path(paste("/zheliu/DevGSEA/result2019/imbalanced_neg_50_sub_", sub.ratio, sep="")), showWarnings = FALSE)
res.dir<- paste("/zheliu/DevGSEA/result2019/imbalanced_neg_50_sub_", sub.ratio, sep="")
...
save.image(paste("/zheliu/DevGSEA/result2019/imbalanced_neg_50_sub_", sub.ratio, "/combined weighted voting.Rdata", sep=""))
